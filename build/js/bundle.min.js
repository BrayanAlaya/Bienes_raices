function darkmode(){document.querySelector(".dark-mode-icon").addEventListener("click",(function(){document.body.classList.add("darkmode")}))}function eventlistener(){document.querySelector(".mobile-menu").addEventListener("click",(function(){navResponsive()}))}function navResponsive(){const e=document.querySelector(".barra-nav");e.classList.contains("mostrar")?e.classList.remove("mostrar"):e.classList.add("mostrar")}
